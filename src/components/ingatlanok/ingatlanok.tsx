		...
		<section className="w-full">
			<div className="container max-w-screen-xl px-4 mx-auto">
				...
				<div className="flex justify-center mt-8">
					<button className="bg-emerald-500 text-white text-lg sm:text-xl font-semibold py-3 px-8 rounded-full shadow-lg hover:bg-emerald-600 transition flex items-center gap-3">
						<FaArrowRight className="text-white text-2xl animate-bounce-right" />
						További ingatlanok megtekintése
					</button>
				</div>
			</div>
		</section>
