        ...
        <section id="eladas-section" className="relative w-full h-[700px] md:h-[800px] flex items-center justify-center text-center text-white overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto px-6">
                ...
                <div className="mt-8 flex justify-center">
                    <Link href="/login">
                        <button className="group px-10 py-4 bg-green-600 hover:bg-green-700 transition-all duration-500 rounded-lg text-lg font-bold shadow-lg flex items-center gap-3 
                            relative overflow-hidden before:absolute before:inset-0 before:bg-green-800 before:scale-0 before:transition-transform before:duration-500 group-hover:before:scale-100">
                            
                            <span className="relative z-10 flex items-center gap-2">
                                <FaSignInAlt className="text-xl animate-fadeInLeft delay-200" />
                                Bejelentkezés
