            ...
            <aside className="relative bg-white/60 backdrop-blur-lg rounded-3xl p-6 shadow-xl w-full max-w-[400px]">
                <div className="relative z-10">
                    ...
                    <div className="flex gap-2">
                        <input type="number" placeholder="Min" className="w-1/2 p-2 border rounded-lg focus:ring focus:ring-emerald-300 focus:border-emerald-500 transition" />
                        <input type="number" placeholder="Max" className="w-1/2 p-2 border rounded-lg focus:ring focus:ring-emerald-300 focus:border-emerald-500 transition" />
                    </div>
                    <label className="block mt-4 mb-2 flex items-center gap-2">
